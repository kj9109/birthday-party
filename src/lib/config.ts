  ...
  itinerary: [
    {
      ...
      date: "May 2",
      events: [
        { time: "2:00 PM", title: "Party Begins at New Hope Winery", description: "Wine, snacks and good vibes" },
        { time: "5:00 PM", title: "Party Continues at Chimney Hill Estate Inn", description: "Settle in, explore the grounds" },
